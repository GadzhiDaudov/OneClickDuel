...
public class P1HuntSpoilerLang : MonoBehaviour {
	...
	public string[] Spoilers2;

	void Start () {
		random1 = Random.Range (0, 4);

		Spoilers [0] = "Убийца Дворецкий";
		Spoilers [1] = "Джон Сноу жив";
		Spoilers [2] = "Канцлер Владыка Ситх";
		Spoilers [3] = "Люк я твой отец (c) Дарт Вейдер";
		Spoilers [4] = "Северус Снегг не предатель";
	}
	...
	void FixedUpdate () {
		if (PlayerPrefs.GetInt ("Lang") == 0) {
			...
			Cont.text = "Continue";
			Resume.text = "Resume";
			Spoiler.text = Spoilers2 [random1];
		}
	}
}
