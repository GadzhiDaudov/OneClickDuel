...
public class P1ShotHSpoiler : MonoBehaviour {
	...
	void Start () {
		...
		RandEnTime = Random.Range (0.09f, 0.39f);
	}
	void Shot () {
	...
	void Update (){
		...
		PLife = PL;
		StopShot = StopShot2;
		enShot = RandTime + 0.37f + RandEnTime + StopShot;

		EnScoreText.text = "PL: " + PLife;
